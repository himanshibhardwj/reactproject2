...
const Vitamins_Supplements = () => {
  return (
    <div className='container'>
        <div className='vitamins_banner mt-20 pt bg-[#A8E0F5] flex items-center justify-center rounded-md'>
            <div className='w-[482px] h-[414px] p-10'>
            ...
            <div className='flex flex-col items-center supplement_content gap-2'>
                ...
                <h2 className='text-[32px] font-bold text-[#184363]'>Vitamins & Supplements</h2>
            ...
            <div className='w-[510px] h-[243px] p-10'>
