    ...
    return (
        <div className='outfit text-sm'>
            <div className='grid grid-cols-3 gap-5'>
                <div className='shadow flex items-center flex-col gap-3 p-3 cursor-pointer' onClick={() => { handleOpenModal(true) }}>
                    <button className='w-[35px] h-[35px]  flex items-center justify-center cursor-pointer rounded-full shadow border-1'>
                        <HiPlus size={20} />
                    </button>
