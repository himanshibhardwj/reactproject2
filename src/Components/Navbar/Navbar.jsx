            ...
            <div className=' flex md:flex-row flex-col  justify-between items-center text-[#56778F] font-bold p-3  lg:p-1 '>
              <div className='flex items-center justify-center gap-10'>
                <div className='flex items-center gap-3'>
                  ...
                  <span className='text-[12px] 2xl:text-[14px] xl:text-[13px] md:text-[12px] lg:text-[13px] font-normal'>Laxmi Nagar, New Delhi - 110092, Delhi, India</span>
                </div>
              ...
              <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center gap-8'>
                  <div className='flex items-center gap-2 py-3'>
                    ...
                    <span className='text-[12px] 2xl:text-[14px] xl:text-[13px] md:text-[12px] lg:text-[13px] font-bold'> <Link to='/loginsignup'>My account</Link></span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='py-5 text-[#184363]'>
            <div className='flex items-center justify-between search_nav 2xl:justify-between xl:justify-between md:gap-3 lg:gap-5'>
              ...
              <div className='w-full flex items-center justify-center 2xl:gap-3 lg:gap-3 md:gap-3 gap-4 '>
                <div className='flex w-[156px] items-center font-bold justify-center text-base border-1 border-[#0071BC1A] rounded-full relative'>
                ...
                <div className=' relative w-7/12 search_nav'>
                  ...
                  <span className='absolute py-1.5 top-0 flex items-center justify-center right-0 text-white rounded-r-[45px] h-full w-1/12 bg-[#0070BC]'><CiSearch size={25} /></span>
                </div>
              </div>
