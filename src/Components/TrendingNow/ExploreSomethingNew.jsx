                        ...
                        {displayedItems.map((item, index) => {
                            return (
                                <SwiperSlide className='p-1'>
                                    <div key={index} className='w-[210px] h-[440px] group shadow-md bg-white flex flex-col items-center gap-5 relative drop-shadow rounded-2xl pt-10 explore_something_new_content'>
                                        <div className=' w-[full] h-[full] max-w-[185px] max-h-[130px] flex items-center justify-center explore_something_new'>
