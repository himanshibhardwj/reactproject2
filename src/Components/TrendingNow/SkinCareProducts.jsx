                        ...
                        {displayedItems.map((item, index) => {
                            return (
                                <SwiperSlide className='p-1'>
                                    <div key={index} className='w-[250px] h-[500px] group shadow-md bg-white flex flex-col items-center gap-5 relative drop-shadow rounded-2xl pt-10 skin_care_content'>
