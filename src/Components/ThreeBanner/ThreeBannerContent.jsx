        ...
        <div className='container_box'>
            <div className='grid 2xl:grid-cols-2 xl:grid-cols-2 md:grid-rows lg:grid-cols-2  mt-20 gap-2 three_banner_content'>
                <div className='flex flex-row justify-between items-center bg-[#F1FAFE] rounded-md three_banner1'>
                    <div className='flex flex-col gap-2 px-4 pt-10 fst_bner'>
                        <button className='cursor-pointer text-[15px] 2xl:text-[20px] xl:text-[18px] md:text-[16px] lg:text-[16px] font-medium bg-[#0071BC] text-white w-5/12 py-2 rounded-md poppins'>25% OFF</button>
                        ...
                        <div className='flex gap-4 text-[#020A13] 2xl:flex-row lg:flex-row md:flex-col xl:flex-row flex-col tax_cntainer'>
                            <span className=' nnt font-extrabold '>₹278.00</span>
                                <span className='poppins tax'>Including Tax</span>
                        </div>
                    </div>
                    <div className='w-8/12 flex items-center justify-center'>
                        <Link to={'/'}><img src={ThreeBaner_1} className='w-full'/></Link>
                    </div>
                </div>
                <div className='flex flex-col gap-3'>
                    <div className='flex 2xl:flex-row lg:flex-row md:flex-row xl:flex-row flex-row justify-between gap-3 bg-[#FDF7E8] rounded-md three_banner1'>
                        <div className='flex flex-col gap-2 pt-10 px-5 fst_bner'>
                            <button className='cursor-pointer text-[15px] 2xl:text-[20px] xl:text-[18px] md:text-[16px] lg:text-[16px] font-medium bg-[#0071BC] text-white w-5/12 py-2 rounded-md poppins'>25% OFF</button>
                            ...
                            <span className='line-through text-[#373D45]'>₹478</span>
                            <div className='flex gap-4 text-[#020A13] flex 2xl:flex-row lg:flex-row md:flex-col xl:flex-row flex-col tax_cntainer'>
                                <span className=' nnt font-extrabold '>₹278.00</span>
                                <span className='poppins tax'>Including Tax</span>
                            </div>
                        </div>
                        <div className='w-8/12 flex items-center justify-center'>
                            <Link to={'/'}><img src={ThreeBaner_2} className='w-full p-4'/></Link>
                        </div>
                    </div>
                    <div className='flex gap-3 bg-[#FDF7E8] flex-row rounded-md three_banner1'>
                        <div className='flex flex-col gap-2 pt-10 px-5 fst_bner'>
                            ...
                            <span className='line-through text-[#373D45]'>₹478</span>
                            <div className='flex flex 2xl:flex-row lg:flex-row md:flex-col xl:flex-row flex-col gap-4 text-[#020A13] tax_cntainer'>
                                <span className=' nnt font-extrabold '>₹278.00</span>
                                <span className='poppins tax'>Including Tax</span>
                            </div>
                        </div>
                        <div className='w-7/12 flex items-center justify-center'>
                            <Link to={'/'}><img src={ThreeBaner_3} className='w-full p-4'/></Link>
                        </div>
                    </div>
                </div>
            </div>
